...
//         <div id='container-about' ref={workContainerRef} className='bg-secondary text-primary border-none rounded-b-3xl font-man'>
...
//                     <h2 className='lg:col-span-7 font-ones lg:col-start-6 col-span-12 flex flex-col xl:text-[6rem] lg:text-[5rem] md:text-[4rem] text-[3rem] space-y-0 gap-0 font-medium leading-none'>
//                         <span className=''>
//                             DEVELOPER, CODER
//                         </span>
//                     </h2>
...
const About = () => {
  ...
  return (
    <section ref={workRef} id='about' className='relative'>
        <div id='container-about' ref={workContainerRef} className='bg-secondary text-primary border-none rounded-b-3xl font-man'>
            <div className='md:px-10 px-6 py-32'>
                
                {/* Header Section */}
                <div className='border-t border-t-[#3f3f38] pt-20 mb-32'>
                    <div className='grid grid-cols-12 gap-8 items-start'>
                        <div className='col-span-1 col-start-2 hidden lg:block'>
                            <LuArrowDownRight size={80} className='text-thin_text'/>
                        </div>
                        <div className='lg:col-span-8 lg:col-start-4 col-span-12'>
                            <h2 className='xl:text-[6rem] lg:text-[5rem] md:text-[4rem] text-[3rem] font-bold leading-none mb-8 font-ones'>
                                DEVELOPER,<br/>CODER
                            </h2>
                            <p className='text-xl md:text-2xl text-primary max-w-[50ch] leading-relaxed font-medium'>
                                With a burning passion to help and develop ideas into reality that can help people. Solve one bug to produce a hundred more, but never giving up. Proudly say as an engineer that the absence of failure is the presence of success.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='grid lg:grid-cols-12 gap-12 lg:gap-16'>
                    ...
                    <div className='lg:col-span-5 flex flex-col justify-center space-y-12'>
                        ...
                        <div className='flex items-center gap-4'>
                            <span className='text-thin_text text-xl tracking-widest uppercase font-medium'>(ABOUT ME)</span>
                            <div className='h-px flex-1 bg-[#3f3f38] max-w-[80px]'></div>
                        </div>

                        {/* Biography */}
                        <div className='space-y-6 text-thin_text text-lg leading-relaxed'>
                            <p>
                                A passionate coder and tutor who thrives on helping others achieve their best while bringing creative ideas to life through the power of technology. Whether it's guiding a fellow learner through a tricky concept or transforming a vision into functional, impactful code, I find joy in building solutions that make a real difference. Crafting data-driven results that are as meaningful as they are efficient.
                            </p>
                            <p>
